...
#define DAUGHTERBOARD_TYPE_M137A	0x11

#define DISPLAY_TYPE_NONE           0x00
#define DISPLAY_TYPE_M150           0x03 // QXGA
#define DISPLAY_TYPE_M180           0x05 // 2Kx2K
...
FDD_RESULT R11_RpcSysReloadRepertoireSkipImages(void);
FDD_RESULT R11_RpcSysReloadRepertoireImageSubset(uint16_t, uint16_t);
...
FDD_RESULT R11_RpcM137CurrentLimitSet(uint8_t);
FDD_RESULT R11_RpcM137CurrentLimitGet(uint8_t *);
FDD_RESULT R11_RpcM137TemperatureLimitSet(uint8_t);
FDD_RESULT R11_RpcM137TemperatureLimitGet(uint8_t *);

...
import imswitch.imreconstructSIM.view.guitools as guitools
from imswitch.imcommon.controller import PickDatasetsController
from imswitch.imreconstructSIM.model import DataObj, ReconObj, PatternFinder, SignalExtractor
...
class ImRecMainViewController(ImRecWidgetController):
    ...
    def reconstructDev(self, currentImage, consolidate):
        '''
        reconstruction
        '''
        ...
        if self.reconstructionMethod == "napari":
            ...
            self._widget.addNewData(imageSIM, "Reconstruction")

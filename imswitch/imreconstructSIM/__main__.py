from imswitch import imreconstructSIM
...
def main():
    ...
    moduleCommChannel.register(imreconstructSIM)
    mainView, mainController = imreconstructSIM.getMainViewAndController(moduleCommChannel)

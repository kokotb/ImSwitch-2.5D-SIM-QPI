...
#Signals to control enabling buttons/SLM/displaying preview window
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.projectFlatnessCorretion = QCheckBox('Project Center')
        self.projectFlatnessCorretion.setChecked(False)
        self.projectFlatnessCorretion.setEnabled(False)
        ...
        self.grid.addWidget(self.projectFlatnessCorretion,0,5)
    ...
    def enableAll(self):
        ...
        self.projectFlatnessCorretion.setEnabled(True)
